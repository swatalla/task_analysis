...
matlabbatch{1}.spm.stats.fmri_spec_spec.dir = b.analys;
matlabbatch{1}.spm.stats.fmri_spec_spec.timing.units = 'secs';
matlabbatch{1}.spm.stats.fmri_spec_spec.timing.RT = 2;
matlabbatch{1}.spm.stats.fmri_spec_spec.fmri_t = 16;
matlabbatch{1}.spm.stats.fmri_spec_spec.fmri_t0 = 8;

for r = 1:4
matlabbatch{1}.spm.stats.fmri_spec_spec.sess(r).scans = b.runs{r};
matlabbatch{1}.spm.stats.fmri_spec_spec.sess(r).cond = struct('name', {}, 'onset', {}, 'duration', {}, 'tmod', {}, 'pmod', {}, 'orth', {});
matlabbatch{1}.spm.stats.fmri_spec_spec.sess(r).multi = b.onset{r};
matlabbatch{1}.spm.stats.fmri_spec_spec.sess(r).regress = struct('name', {}, 'val', {});
matlabbatch{1}.spm.stats.fmri_spec_spec.sess(r).multi_reg = b.art{r};
matlabbatch{1}.spm.stats.fmri_spec_spec.sess(r).hpf = 128;
end

matlabbatch{1}.spm.stats.fmri_spec_spec.fact = struct('name', {}, 'levels', {});
matlabbatch{1}.spm.stats.fmri_spec_spec.bases.hrf.derivs = [0 0];
matlabbatch{1}.spm.stats.fmri_spec_spec.volt = 1;
matlabbatch{1}.spm.stats.fmri_spec_spec.global = 'None';
matlabbatch{1}.spm.stats.fmri_spec_spec.mthresh = 0.8;
matlabbatch{1}.spm.stats.fmri_spec_spec.mask = {''};
matlabbatch{1}.spm.stats.fmri_spec_spec.cvi = 'none';

%matlabbatch{2}.spm.stats.fmri_spec_est.spmmat(1) = cfg_dep('fMRI model specification: SPM.mat File', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','spmmat'));
%matlabbatch{2}.spm.stats.fmri_spec_est.method.Classical = 1;